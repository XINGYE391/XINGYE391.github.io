...
$.ajax({
  ...
  data: {
    key: 'GXKBZ-TQSL3-2F63M-OX3OL-OUP7J-DGBI2',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(121.482075,38.923897, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
/* 开往 start */
function travel(){
    var url = 'https://www.travellings.cn/go.html'; // 目标URL
...
function createtime1() {
  var grt = new Date("04/07/2024 00:00:00"); //此处修改你的建站时间或者网站上线时间
  ...
  var ascll = [
    `欢迎来到XINGYEのBlog!`,
    `
    Y88b   d88P 8888888 888b    888  .d8888b.  Y88b   d88P 8888888888 
    Y88b d88P    888   8888b   888 d88P  Y88b  Y88b d88P  888        
     Y88o88P     888   88888b  888 888    888   Y88o88P   888        
      Y888P      888   888Y88b 888 888           Y888P    8888888    
      d888b      888   888 Y88b888 888  88888     888     888        
     d88888b     888   888  Y88888 888    888     888     888        
    d88P Y88b    888   888   Y8888 Y88b  d88P     888     888        
   d88P   Y88b 8888888 888    Y888  "Y8888P88     888     8888888888                                                                                                                                                                                                          
`,
    "小站已经苟活",
    dnum,
    "天啦!",
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by XINGYE %c 你正在访问XINGYEのBlog",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| XINGYE") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('XINGYE的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
document.addEventListener('visibilitychange', function () {
  if (document.hidden) {
    //离开当前页面时标签显示内容
    document.title = '(つ﹏<)･ﾟ网页突然崩溃了！';
    clearTimeout(titleTime);
  } else {
    //返回当前页面时标签显示内容
    document.title = '♪(^∇^*)诶嘿嘿~ 又好了！';
    //两秒后变回正常标题
...
function createtime() {
  ...
  // 网站诞生时间
  var grt = new Date("04/07/2024 00:00:00");
...
<p id="swfs">
<a class="swf" id="swf_ZhuZiAWan" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZhuZiAWan'!important;color:black" onclick="setFont('ZhuZiAWan')">筑紫</a>
...
function whenDOMReady() {
  if (location.pathname == '/personal/essay/') setTimeout(() => { changeTime(), btf.loadLightbox(document.querySelectorAll('#icat-bber img')), window.lazyLoadInstance && window.lazyLoadInstance.update(), reflashWaterFall();}, 300)
}
whenDOMReady()
